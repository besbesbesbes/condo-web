...
export function EditIcon(props) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        d="M13.94 5L19 10.06 9.062 20a2.25 2.25 0 01-.999.58l-5.116 1.395a.75.75 0 01-.92-.921l1.395-5.116a2.25 2.25 0 01.58-.999L13.938 5zm7.09-2.03a3.578 3.578 0 010 5.06l-.97.97L15 3.94l.97-.97a3.578 3.578 0 015.06 0z"
        fill="currentColor"
        fillRule="nonzero"
        stroke="none"
        strokeWidth={1}
  ...
  return (
    ...
    >
      <g transform="translate(0,600) scale(0.1,-0.1)">
        <path d="M2375 5509 c-382 -48 -789 -268 -1051 -566 -254 -291 -421 -688 -443 -1053 -26 -427 99 -850 354 -1195 62 -83 210 -243 257 -276 l27 -19 -34 68 c-180 371 -94 804 227 1132 171 175 385 295 638 358 l105 26 955 6 c1063 7 996 2 1145 77 147 74 266 190 341 335 84 164 105 334 64 519 -67 306 -332 544 -653 588 -96 13 -1827 13 -1932 0z" />
        <path d="M4368 3263 c67 -115 102 -244 102 -381 0 -124 -22 -217 -80 -337 -118 -245 -353 -427 -645 -502 -108 -27 -115 -28 -410 -28 -165 0 -604 2 -975 5 -670 5 -676 4 -752 -17 -322 -91 -522 -273 -610 -553 -33 -106 -33 -302 0 -406 67 -216 209 -382 407 -479 153 -74 68 -69 1260 -73 713 -2 1097 1 1151 8 122 16 245 55 379 120 646 313 991 1074 803 1775 -25 96 -97 277 -135 343 -115 200 -258 371 -413 493 -109 86 -115 88 -82 32z" />
      </g>
    </svg>
  );
}

export function NoTrans(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <g fill="currentColor">
        <path d="M5.857 3a3 3 0 00-3 3v12a3 3 0 003 3h6.165a6.463 6.463 0 01-.848-2H5.857a1 1 0 01-1-1V6a1 1 0 011-1h12a1 1 0 011 1v5.142a6.459 6.459 0 012 .791V6a3 3 0 00-3-3h-12z" />
        <path d="M17.5 23a5.5 5.5 0 100-11 5.5 5.5 0 000 11zm-3.309-3.252a4 4 0 015.557-5.557l-5.557 5.557zm1.06 1.06l5.558-5.556a4 4 0 01-5.557 5.557z" />
      </g>
    </svg>
  );
}
...
export function UserIcon(props) {
  return (
    <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        d="M35.75 28a4.25 4.25 0 014.245 4.043l.005.206V33c0 3.755-1.942 6.567-4.92 8.38C32.15 43.163 28.214 44 24 44s-8.15-.837-11.08-2.62c-2.888-1.758-4.801-4.455-4.915-8.041L8 33v-.751a4.25 4.25 0 014.044-4.244L12.25 28h23.5zM24 4c5.523 0 10 4.477 10 10s-4.477 10-10 10-10-4.477-10-10S18.477 4 24 4z"
        fill="currentColor"
        fillRule="nonzero"
        stroke="none"
        strokeWidth={1}
...
export function TypeIcon(props) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        d="M18.25 3A2.75 2.75 0 0121 5.75v12.5A2.75 2.75 0 0118.25 21H5.75A2.75 2.75 0 013 18.25V5.75A2.75 2.75 0 015.75 3h12.5zm0 1.5H5.75c-.69 0-1.25.56-1.25 1.25v12.5c0 .69.56 1.25 1.25 1.25h12.5c.69 0 1.25-.56 1.25-1.25V5.75c0-.69-.56-1.25-1.25-1.25zm-8.498 8c.966 0 1.75.784 1.75 1.75v2A1.75 1.75 0 019.752 18h-2a1.75 1.75 0 01-1.75-1.75v-2c0-.966.783-1.75 1.75-1.75h2zm6.497 0c.967 0 1.75.784 1.75 1.75v2A1.75 1.75 0 0116.25 18h-2a1.75 1.75 0 01-1.75-1.75v-2c0-.966.784-1.75 1.75-1.75h2zM9.751 6c.966 0 1.75.784 1.75 1.75v2a1.75 1.75 0 01-1.75 1.75h-2A1.75 1.75 0 016 9.75v-2C6 6.784 6.784 6 7.75 6h2zm6.497 0c.967 0 1.75.784 1.75 1.75v2a1.75 1.75 0 01-1.75 1.75h-2a1.75 1.75 0 01-1.75-1.75v-2c0-.966.784-1.75 1.75-1.75h2z"
        fill="currentColor"
        fillRule="nonzero"
        stroke="none"
        strokeWidth={1}
...
export function PasswordIcon(props) {
  return (
    ...
    >
      <path
        d="M5.25 5A3.25 3.25 0 002 8.25v7.5A3.25 3.25 0 005.25 19h13.5A3.25 3.25 0 0022 15.75v-7.5A3.25 3.25 0 0018.75 5H5.25zm1.03 5.22l.72.72.72-.72a.75.75 0 111.06 1.06l-.719.72.72.718A.75.75 0 117.72 13.78L7 13.06l-.72.72a.75.75 0 01-1.06-1.06l.72-.72-.72-.72a.75.75 0 011.06-1.06zm5.5 0l.72.72.72-.72a.75.75 0 111.06 1.06l-.719.72.72.718a.75.75 0 11-1.061 1.061l-.72-.719-.72.72a.75.75 0 11-1.06-1.06l.72-.72-.72-.72a.75.75 0 011.06-1.06zm3.97 4.03a.75.75 0 01.75-.75h1.75a.75.75 0 010 1.5H16.5a.75.75 0 01-.75-.75z"
        fill="currentColor"
      />
    </svg>
  );
...
export function UnHideIcon(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <g
        ...
        strokeLinejoin="round"
      >
        <path d="M2.42 12.713c-.136-.215-.204-.323-.242-.49a1.173 1.173 0 010-.446c.038-.167.106-.274.242-.49C3.546 9.505 6.895 5 12 5s8.455 4.505 9.58 6.287c.137.215.205.323.243.49.029.125.029.322 0 .446-.038.167-.106.274-.242.49C20.455 14.495 17.105 19 12 19c-5.106 0-8.455-4.505-9.58-6.287z" />
...
export function SortNewIcon(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SortOldIcon(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SaveIcon(props) {
  return (
    ...
    >
      <path
        d="M8 20H6a2 2 0 01-2-2V6a2 2 0 012-2h3M8 20v-6a1 1 0 011-1h6a1 1 0 011 1v6m-8 0h8m0 0h2a2 2 0 002-2V8.828a2 2 0 00-.586-1.414l-2.828-2.828A2 2 0 0015.172 4H15m0 0v3a1 1 0 01-1 1h-4a1 1 0 01-1-1V4m6 0H9"
        stroke="currentColor"
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function RequestBuddyIcon(props) {
  return (
    ...
    >
      <path
        d="M3 11h5m-2.5 2.5v-5m9 5.5c3.797 0 5.73 1.337 6.31 4.012C21.042 19.092 20.104 20 19 20h-9c-1.105 0-2.043-.908-1.81-1.988C8.77 15.337 10.704 14 14.5 14zm0-4c1.667 0 2.5-.857 2.5-3s-.833-3-2.5-3-2.5.857-2.5 3 .833 3 2.5 3z"
        stroke="currentColor"
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
